            ...
            $message = '<b>Mật khẩu nhập lại không khớp !</b>';
                    ...
                    if (mysqli_num_rows($kq1) > 0 && mysqli_num_rows($kq2) > 0 ) {
                        ...
                        $message = '<b>Số điện thoại đăng ký đã tồn tại!</b>';
                            ...
                            $sql = "INSERT INTO thanhvien (hoten, gmail, matkhau, sdt, quyentruycap) VALUES ('$name','$email', '$password' ,'$sdt', 1)";
...
<?php include('topnav.php');?>
    <h1 style="text-align: center; margin-top: 3%; margin-bottom: 3%; ">Đăng ký tài khoản quản lý</h1>
    <div class="container">
